...
- `lode task edit` — Edit a task's title, body, concern, priority, or needs-decomposition flag
  Flags: --body, --body-file, --concern, --needs-decomposition, --no-upload, --priority, --secrets, --title
