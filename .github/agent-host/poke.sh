...
poke_text="Ready work is available. Start a lode-worker agent and run the loop again: \`lode next --json $*\`, then work the claimed task from its brief as in your initial instructions."
