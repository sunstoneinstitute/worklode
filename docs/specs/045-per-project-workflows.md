...
### 1.1 Vocabulary and machine are different things {#sec-1.1}
...
### 1.2 The mandatory core {#sec-1.2}
...
### 1.3 Optional states and declared entries {#sec-1.3}
...
### 1.4 The default workflow {#sec-1.4}
...
## 3. Which workflow governs a task {#sec-3}
...
## 5. Every state reader, accounted for {#sec-5}
...
### 5.1 Core — unchanged, unconditionally correct {#sec-5.1}
...
### 5.2 Vocabulary-static sets — stay, stay sound {#sec-5.2}
...
### 5.3 Workflow-resolved — the two real changes {#sec-5.3}
...
### 5.4 Hierarchy — parents move only in the core {#sec-5.4}
...
### 5.5 Display — degrades gracefully, unchanged in v1 {#sec-5.5}
...
## 6. Changing a workflow: review, not a gate {#sec-6}
...
### 6.3 LLM authorship and the WL-60 boundary {#sec-6.3}
...
## 7. Relation to `done_state` and Deliverable {#sec-7}
...
## 10. Non-goals and deferred {#sec-10}
