...
# Spec 020 — Inbox import (onboarding a repo with history) — consolidated view
...
> Source of record: [`docs/specs/020-inbox-import.md`](../020-inbox-import.md) — status **draft**.
>
...
## 1. How the gap stayed invisible
...
### 2.1 Import is inventory, not replay
...
### 3.1 Fetch — `internal/githubauth/list.go`
...
### 3.2 API — `POST /api/v1/inbox/import`
...
### 3.4 Link — `lode inbox link <repo> <number> <task-id>`
