...
# Spec 029 — Research work in the backbone: projects, milestones, deliverables, approvals — consolidated view
...
> Source of record: [`docs/specs/029-research-work-in-the-backbone.md`](../029-research-work-in-the-backbone.md) — status **draft**.
>
...
## 1. The investigation is a project
...
### 6.1 Assignee, participants, contributors
...
## 8. Intake, events, and notifications
