...
# Spec 019 — Repo-scoped CLI commands — consolidated view
...
> Source of record: [`docs/specs/019-project-scoping.md`](../019-project-scoping.md) — status **draft**.
>
...
### 3.1 `GET /api/v1/projects/resolve?remote=<url>`
...
### 3.2 `GET /api/v1/inbox?project=<id>`
...
### 4.2 `lode project resolve [--refresh]`
