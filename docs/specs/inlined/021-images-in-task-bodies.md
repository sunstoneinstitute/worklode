...
# Spec 021 — Images and attachments on tasks — consolidated view
...
> Source of record: [`docs/specs/021-images-in-task-bodies.md`](../021-images-in-task-bodies.md) — status **draft**.
>
