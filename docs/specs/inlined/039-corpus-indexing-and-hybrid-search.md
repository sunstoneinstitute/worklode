...
# Spec 039 — Corpus indexing and hybrid search — consolidated view
...
> Source of record: [`docs/specs/039-corpus-indexing-and-hybrid-search.md`](../039-corpus-indexing-and-hybrid-search.md) — status **draft**.
>
