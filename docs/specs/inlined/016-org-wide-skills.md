...
# Spec 016 — Org-wide agent skills — consolidated view
...
> Source of record: [`docs/specs/016-org-wide-skills.md`](../016-org-wide-skills.md) — status **draft**.
>
...
## 5. Brief integration & activation
