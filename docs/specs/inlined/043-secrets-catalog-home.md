...
# ADR 043 — Where the secrets catalog lives — consolidated view
...
> Source of record: [`docs/specs/043-secrets-catalog-home.md`](../043-secrets-catalog-home.md) — status **draft**.
>
