...
# Spec 006 — Knowledge graph: vocabulary, entity model, runtime layer & projection — consolidated view
...
> Source of record: [`docs/specs/006-knowledge-graph.md`](../006-knowledge-graph.md) — status **draft**.
>
...
### 1.1 Reuse survey: the runtime layer
...
## 5. Task-kind & model-layer SKOS schemes
...
## 7. Reasoning architecture (OWL / SHACL / SPARQL)

> Pending `049-validate-project-graphs-as-a-union.md#sec-3` (not yet effective)
...
### 8.2 Layer 2 — Execution · VCS (observed)
...
## 9. Deliverable — declared definition-of-done
...
## 13. What the data-platform must host
...
### 13.4 Explicitly not required from the data-platform
