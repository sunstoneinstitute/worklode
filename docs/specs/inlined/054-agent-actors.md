...
# Spec 054 — Agent actors — consolidated view
...
> Source of record: [`docs/specs/054-agent-actors.md`](../054-agent-actors.md) — status **draft**.
>
...
## 2. Dimensions that are not identities
...
## 5. Launch profiles are configuration
