...
# Spec 013 — Reconciliation & setup diagnosis — consolidated view
...
> Source of record: [`docs/specs/013-reconciliation.md`](../013-reconciliation.md) — status **draft**.
>
