...
# Spec 041 — Pi agent integration — consolidated view
...
> Source of record: [`docs/specs/041-pi-agent-integration.md`](../041-pi-agent-integration.md) — status **draft**.
>
...
## 1. Package boundary and installation
