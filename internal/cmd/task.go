...
func newTaskAddCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&kind, "kind", "feature", "kind: feature, bug, chore, design, review, spike, decision, rally")
...
func newTaskListCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&kind, "kind", "", "filter by kind: feature, bug, chore, design, review, spike, decision, rally")
...
func newTaskEditCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&kindFlag, "kind", "", "retag the task's kind: feature, bug, chore, design, review, spike, decision, rally")
	completeFlagValues(cmd, "priority", model.TaskPriorities)
	completeFlagValues(cmd, "kind", ns.TaskKinds)
