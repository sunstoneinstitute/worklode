...
func TestEvaluate(t *testing.T) {
	cases := []struct {
		...
		{
			name: "substantive patch mints re-review",
			in: watcher.Input{
				EventID:        50,
				EventType:      watcher.TypeDocPatched,
				DocIRI:         "wlid:doc/spec-025",
				DocKind:        "spec",
				DocTitle:       "Documents in the backbone",
				DocRef:         "WL-SPEC-25",
				...
				ChangedAnchors: []string{"sec-7.3", "sec-8.4"},
			},
			want: []watcher.Action{{
				Rule:     "review-on-patch",
				TaskKind: "review",
				Title:    "Re-review patched sections of WL-SPEC-25: sec-7.3, sec-8.4",
			}},
		},
		{
			name: "non-substantive patch mints nothing",
			in: watcher.Input{
				EventID:        51,
				EventType:      watcher.TypeDocPatched,
				DocIRI:         "wlid:doc/spec-025",
				...
				ChangedAnchors: []string{"sec-7.3"},
			},
			want: nil,
		},
		{
			name: "substantive patch with open review task suppressed",
			in: watcher.Input{
				EventID:        52,
				EventType:      watcher.TypeDocPatched,
				DocIRI:         "wlid:doc/spec-025",
